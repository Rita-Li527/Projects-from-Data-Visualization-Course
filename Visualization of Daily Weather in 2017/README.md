...
![Histogram of count of weather stations](src/states.png)

![Map of all weather stations in United States](src/stations.png)
...
![A violin plot of daily temperature difference in five states](src/violin.jpg)
...
![A boxplot of daily temperature difference of five states in three seasons](src/boxplot.jpg)
...
![Radar chart of Wind Direaction](src/wind.png)
...
![A lollipop plot of snow days](src/snow.jpg)
...
![A lollipop plot of rain days](src/rain.jpg)
